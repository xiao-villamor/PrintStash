/*
 * Proves the authenticated browser helper follows a capability-safe S3 redirect
 * without sending Artifact bytes or application credentials through the API.
 */
...
test.describe("native artifact delivery", () => {
  test("downloads S3 bytes through the authenticated helper", async ({ page, baseURL }) => {
