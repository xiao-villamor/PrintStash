...
const messages = {
  en: {
    ...
    "parts.title": "Part options",
    "parts.description":
      "Group interchangeable source files, such as short and long handles, under one physical part.",
    "parts.manage": "Manage options",
    "parts.empty": "No part options configured.",
    "parts.default": "Default",
    "parts.dialogTitle": "Manage part options",
    "parts.groupName": "Part name",
    "parts.groupPlaceholder": "e.g. Handle",
    "parts.optionName": "Option name",
    "parts.optionPlaceholder": "e.g. Long",
    "parts.sourceFile": "Source file",
    "parts.makeDefault": "Use as default",
    "parts.removeOption": "Remove option",
    "parts.removeGroup": "Remove part",
    "parts.addOption": "Add option",
    "parts.addGroup": "Add part",
    "parts.cancel": "Cancel",
    "parts.save": "Save options",
    "parts.saving": "Saving…",
    "parts.saved": "Part options updated",
    "parts.invalid":
      "Each part needs a name, at least two named files, and one default option. A file can only be used once.",
    "parts.needFiles": "Add at least two source files before creating alternatives.",
  },
  es: {
    "locale.label": "Idioma",
    "locale.en": "Inglés",
    ...
    "parts.title": "Opciones de piezas",
    "parts.description":
      "Agrupa archivos fuente intercambiables, como asas cortas y largas, bajo una misma pieza física.",
    "parts.manage": "Gestionar opciones",
    "parts.empty": "No hay opciones de piezas configuradas.",
    "parts.default": "Predeterminada",
    "parts.dialogTitle": "Gestionar opciones de piezas",
    "parts.groupName": "Nombre de la pieza",
    "parts.groupPlaceholder": "p. ej., Asa",
    "parts.optionName": "Nombre de la opción",
    "parts.optionPlaceholder": "p. ej., Larga",
    "parts.sourceFile": "Archivo fuente",
    "parts.makeDefault": "Usar como predeterminada",
    "parts.removeOption": "Eliminar opción",
    "parts.removeGroup": "Eliminar pieza",
    "parts.addOption": "Añadir opción",
    "parts.addGroup": "Añadir pieza",
    "parts.cancel": "Cancelar",
    "parts.save": "Guardar opciones",
    "parts.saving": "Guardando…",
    "parts.saved": "Opciones de piezas actualizadas",
    "parts.invalid":
      "Cada pieza necesita un nombre, al menos dos archivos con nombre y una opción predeterminada. Cada archivo solo puede usarse una vez.",
    "parts.needFiles": "Añade al menos dos archivos fuente antes de crear alternativas.",
  },
} as const;
