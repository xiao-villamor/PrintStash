...
const messages = {
  en: {
    ...
    "vault.models": "Models",
    "vault.multipart": "Multipart models",
    ...
    "multipart.title": "Multipart models",
    "multipart.description":
      "Create a named set of existing Models that print together. Adding a part only links a Model; its files and revisions stay in your library.",
    "multipart.new": "New multipart model",
    "multipart.name": "Name",
    ...
    "multipart.create": "Create multipart model",
    ...
    "multipart.addAlternative": "Add an alternative",
    ...
    "multipart.delete": "Delete multipart model",
    "multipart.deleteTitle": "Delete this multipart model?",
    "multipart.deleteDescription":
      "Only this grouping will be removed. Models, files and revisions stay in your library.",
    "multipart.deleteConfirm": "Delete grouping",
    "multipart.deleted": "Multipart model deleted",
    ...
    "multipart.notFound": "Multipart model not found",
  ...
  es: {
    ...
    "vault.multipart": "Modelos multiparte",
    ...
    "multipart.title": "Modelos multiparte",
    "multipart.description":
      "Crea un conjunto con nombre de modelos existentes que se imprimen juntos. Añadir una pieza solo enlaza un modelo; sus archivos y revisiones permanecen en la biblioteca.",
    "multipart.new": "Nuevo modelo multiparte",
    ...
    "multipart.create": "Crear modelo multiparte",
    ...
    "multipart.addAlternative": "Añadir una alternativa",
    ...
    "multipart.delete": "Eliminar modelo multiparte",
    "multipart.deleteTitle": "¿Eliminar este modelo multiparte?",
    "multipart.deleteDescription":
      "Solo se eliminará la agrupación. Los modelos, archivos y revisiones permanecerán en tu biblioteca.",
    "multipart.deleteConfirm": "Eliminar agrupación",
    "multipart.deleted": "Modelo multiparte eliminado",
