...
const ES_PHRASES: ReadonlyArray<readonly [string, string]> = [
  ...
  ["Needed for reliable reconnection while paused or errored.", "Necesario para reconectar de forma fiable cuando está pausada o en error."],
  ...
  ["Used for reliable reconnection", "Se usa para una reconexión fiable"],
