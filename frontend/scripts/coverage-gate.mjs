...
const SUITES = [
  {
    ...
    total: { statements: 81.1, branches: 75.3 },
    areas: [
      ...
      { prefix: "src/lib/", statements: 92.8, branches: 83.5 },
      ...
      { prefix: "src/components/", statements: 78.2, branches: 73.9 },
      ...
      { prefix: "src/pages/", statements: 84.5, branches: 76.2 },
