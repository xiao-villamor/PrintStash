...
const SUITES = [
  {
    ...
    total: { statements: 81.4, branches: 75.4 },
    areas: [
      ...
      { prefix: "src/lib/", statements: 92.8, branches: 83.0 },
      ...
      { prefix: "src/components/", statements: 78.2, branches: 73.6 },
      ...
      { prefix: "src/pages/", statements: 86.5, branches: 78.5 },
