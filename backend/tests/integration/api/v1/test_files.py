...
not exercised by tests/integration/api/v1/models/, tests/integration/api/v1/ingest/,
or tests/integration/api/v1/models/test_slicer_download.py."""
...
class TestThumbnailRebuildInternals:
    ...
    which the happy-path API tests in ``tests/integration/api/v1/ingest/`` do not reach."""
